...
class BeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beat" do
    assert_difference('Beat.count') do
      post beats_url, params: { beat: { price: @beat.price, scale: @beat.scale, tempo: @beat.tempo, title: @beat.title } }
    end
  ...
  test "should update beat" do
    patch beat_url(@beat), params: { beat: { price: @beat.price, scale: @beat.scale, tempo: @beat.tempo, title: @beat.title } }
